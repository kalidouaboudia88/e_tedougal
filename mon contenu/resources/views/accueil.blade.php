      ...
      <div class="col-lg-9">
        ...
        <div class="row">
         ...
         @foreach($products as $product)
          ...
          <a href="#"><img class="card-img-top" src="{{$product->image_produit ?? asset('uploads/images/default.png')}}" height="250" width="250" alt=""></a>
          <div class="card-body">
           <h4 class="card-title">
               <a href="/products/{{$product->id ?? ''}}/show">{{$product->name}}</a>
           </h4>
           <div>Prix: {{$product->prix}} franc</div>
           <div>{{$product->description_produit}}</div>
           <p class="card-text">{!! \Illuminate\Support\Str::words($product->description_produit, 25,'....')  !!}</p>
